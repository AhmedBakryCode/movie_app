...
import 'package:movies_app/core/services/sevice_locator.dart';
...
import '../component/now_playing_movies.dart';
class MainMoviesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context)=>sl<MoviesBloc>()..add(GetNowPlayingEvent())..add(GetPopularEvent())..add(GetNowTopRatedEvent()),
      child: Scaffold(
